...
export class BookmarkService extends ObservableStore<StoreState> {
    private baseUrlCreateBookMark = 'https://urlbook.herokuapp.com/api/v1/bookmark/addbookmark';
    private baseUrlgetBookMarks = 'https://urlbook.herokuapp.com/api/v1/bookmark/GetAllcards';
    private baseUrlApproveBookMark = 'https://urlbook.herokuapp.com/api/v1/bookmark/Approve';
