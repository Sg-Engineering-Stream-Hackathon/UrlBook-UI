...
export class CommonuserService {
    private baseUrlUsers = 'https://urlbook.herokuapp.com/api/v1/profile/GetAllUsers';
    private baseUrlUpdateUserRoles = 'https://urlbook.herokuapp.com/api/v1/profile/UpdateProfile';
